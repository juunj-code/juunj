...
|---|----------|----------|----------|------|-----------|-------------|
| 1 | 턴제 전투 | Gameplay | MVP | Approved | design/gdd/턴제-전투.md | #6, #7, #12, #13, #10, #11, #15, #4 |
...
| 16 | 런 결과 | Progression | MVP | Approved | design/gdd/런-결과.md | #13, #14 |
...
| 21 | 오디오 | Audio | Vertical Slice | Approved | design/gdd/오디오.md | #19, #1, #9, #13, #11 |
...
1. **#1 턴제 전투** — 턴 순서·공격·스킬·도망 로직 → #6, #7, #12, #13, #10, #11, #15, #4 (장비 반영 base stat 조회)
...
6. **#9 히든 트리거** — 히든방·히든동료 발생 조건 평가 → #13 런 상태 관리(`room_entered` 신호 구독), #10 동료 데이터, #14 영구 진행, #4 장비(재진입 드롭 재사용)
...
| 설계 문서 승인됨 | 18 |
| MVP 시스템 설계 완료 | 18 / 18 |
| Vertical Slice 시스템 설계 완료 | 2 / 2 — 둘 다 Approved (#8 시너지: 2026-08-08 독립 /design-review, NEEDS REVISION → blocking 4건 해결 후 승인. #21 오디오: 2026-08-08 독립 /design-review(백그라운드 서브에이전트), NEEDS REVISION → blocking 6건 해결 후 승인) |
